...
const CheckmarkIcon = ({ width, height, color }: IconStyleProps) => (
    <svg width={width || '800px'} height={height || '800px'} viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Icon-Set" transform="translate(-100.000000, -1139.000000)" fill={color || '#1C274C'}>
