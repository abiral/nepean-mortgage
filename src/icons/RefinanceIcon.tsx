...
const RefinanceIcon = ({ width, height, color }: IconStyleProps) => (
    <svg width={width || '800px'} height={height || '800px'} fill={color || '#1C274C'} version="1.0" xmlns="http://www.w3.org/2000/svg"
